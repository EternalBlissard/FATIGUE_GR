...
# TODO: Wandb
WANDB_PROJECT_NAME = "IMU_Gesture_LOSO_CNNGRU_MultiArray" 
...
def train_participant_model(current_p_id, all_participant_data, wandb_project_name):
    ...
    run = wandb.init(
        ...
        config={
            ...
            "model_type": "CNN_GRU_IMU_MultiArray",
            "test_participant": current_p_id
        },
        reinit=True 
    )

    model = CNNGRU_IMU(num_sensors=NUM_SENSORS, sequence_length=WINDOW_LENGTH, num_classes=NUM_GESTURES)
